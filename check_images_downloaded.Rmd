...
```{r setup, echo=FALSE, message=FALSE, warning=FASLE}
...
```{r}
plant_dirs <- list.dirs("images", )[-1]
plant_names <- basename(plant_dirs)
```
...
Number of unique plants: `r n_distinct(plant_names)`  
